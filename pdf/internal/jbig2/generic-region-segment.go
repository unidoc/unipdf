...
func (g *GenericRegionSegment) Init(h *SegmentHeader, r reader.StreamReader) error {
...
func (g *GenericRegionSegment) GetRegionInfo() *RegionSegment {
	return g.RegionSegment
}

func (g *GenericRegionSegment) parseHeader() (err error) {
	common.Log.Debug("[GenericRegionSegment] ParsingHeader...")
	defer func() {
		if err != nil {
			common.Log.Debug("[GenericRegionSegment] ParsingHeader Finished with error...")
		} else {
			common.Log.Debug("[GenericRegionSegment] ParsingHeader Finished Succesfully...")
		}
	}()
...
func (g *GenericRegionSegment) decodeTemplate2(lineNumber, width, paddedWidth int, byteIndex, idx int) (err error) {
	var (
		context, overriddenContext int
		line1, line2               int
...
func (g *GenericRegionSegment) setParametersMMR(
	isMMREncoded bool,
	dataOffset, dataLength int64,
	gbh, gbw int,
	gbTemplate byte,
