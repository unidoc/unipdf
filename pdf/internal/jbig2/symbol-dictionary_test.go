...
func TestSymbolDictionaryDecode(t *testing.T) {
	...
	t.Run("1st", func(t *testing.T) {
		...
		assert.Equal(t, TSymbolDictionary, h.SegmentType)
		...
		s, ok := sg.(*SymbolDictionarySegment)
		require.True(t, ok)
	...
	t.Run("17th", func(t *testing.T) {
		...
		t.Run("18th", func(t *testing.T) {
			...
			assert.Equal(t, TSymbolDictionary, eighteenH.SegmentType)
			...
			eighteenSD, ok := seg.(*SymbolDictionarySegment)
			require.True(t, ok)
