...
// GenericRefinementRegion represtents jbig2
...
func newGenericRefinementRegion(r reader.StreamReader, h *SegmentHeader) *GenericRefinementRegion {
...
func (g *GenericRefinementRegion) Init(header *SegmentHeader, r reader.StreamReader) error {
	g.h = header
	g.r = r
