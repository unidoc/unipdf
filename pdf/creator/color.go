...
// Represents RGB color values in the PDF creator.
...
func ColorRGBFromHex(hexStr string) rgbColor {
	color := rgbColor{}
...
func ColorRGBFrom8bit(r, g, b byte) rgbColor {
	color := rgbColor{}
...
func ColorRGBFromArithmetic(r, g, b float64) rgbColor {
