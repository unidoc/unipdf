...
func (_gf *Model )Namespaces ()_eb .NamespaceList {return _eb .NamespaceList {Namespace }};
...
func (_aa *Model )CanTag (tag string )bool {_ ,_gfc :=_eb .GetNativeField (_aa ,tag );return _gfc ==nil ;};const (ValueTypeNameBoolean ValueTypeName ="\u0042o\u006f\u006c\u0065\u0061\u006e";ValueTypeNameDate ValueTypeName ="\u0044\u0061\u0074\u0065";ValueTypeNameInteger ValueTypeName ="\u0049n\u0074\u0065\u0067\u0065\u0072";
...
func GetSchema (namespaceURI string )(*Schema ,bool ){_dgg .RLock ();defer _dgg .RUnlock ();_be ,_fg :=_cde [namespaceURI ];return _be ,_fg ;};
...
func (_bf *Model )Can (nsName string )bool {return Namespace .GetName ()==nsName };const (ValueTypeResourceEvent ValueTypeName ="\u0052\u0065\u0073\u006f\u0075\u0072\u0063\u0065\u0045\u0076\u0065\u006e\u0074";);
...
func (_bdf *Model )SyncFromXMP (d *_eb .Document )error {return nil };

// MakeModel creates or gets a model from document.
func MakeModel (d *_eb .Document )(*Model ,error ){_bd ,_cb :=d .MakeModel (Namespace );if _cb !=nil {return nil ,_cb ;};return _bd .(*Model ),nil ;};

// PropertyCategory is the property category enumerator.
type PropertyCategory int ;

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_cgg *Schemas )UnmarshalXMP (d *_eb .Decoder ,node *_eb .Node ,m _eb .Model )error {return _eb .UnmarshalArray (d ,node ,_cgg .Typ (),_cgg );};

// ValueTypes is the slice of field value types.
type ValueTypes []FieldValueType ;

// MarshalXMP implements xmp.Marshaler interface.
func (_ebf ValueTypes )MarshalXMP (e *_eb .Encoder ,node *_eb .Node ,m _eb .Model )error {return _eb .MarshalArray (e ,node ,_ebf .Typ (),_ebf );};