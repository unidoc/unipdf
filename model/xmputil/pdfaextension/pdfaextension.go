...
case PropertyCategoryUndefined :return []byte (""),nil ;default:return nil ,_c .Errorf ("\u0075\u006ed\u0065\u0066\u0069\u006ee\u0064\u0020p\u0072\u006f\u0070\u0065\u0072\u0074\u0079\u0020c\u0061\u0074\u0065\u0067\u006f\u0072\u0079\u0020\u0076\u0061\u006c\u0075e\u003a\u0020\u0025\u0076",_fc );
};};
...
func (_cc *Model )SyncToXMP (d *_eg .Document )error {return nil };func _ega (_bcg _eg .Model ,_bfc *_eg .Namespace ,_baf Property )bool {_fd :=_e .ValueOf (_bcg ).Elem ();if _fd .Kind ()==_e .Ptr {_fd =_fd .Elem ();};_db :=_fd .Type ();for _daa :=0;_daa < _db .NumField ();
_daa ++{_dbg :=_db .Field (_daa );_ed :=_dbg .Tag .Get ("\u0078\u006d\u0070");if _ed ==""{continue ;};if !_a .HasPrefix (_ed ,_bfc .Name ){continue ;};_ee :=_a .IndexRune (_ed ,':');if _ee ==-1{continue ;};_fda :=_ed [_ee +1:];if _fda ==_baf .Name {_bgg :=_fd .Field (_daa );
return !_bgg .IsZero ();};};return false ;};

// ValueTypes is the slice of field value types.
type ValueTypes []FieldValueType ;

// NewModel creates a new pdfAExtension model.
func NewModel (name string )_eg .Model {return &Model {}};func init (){_cb =map[string ]*Schema {_b .NsXmpMM .URI :&XmpMediaManagementSchema ,"\u0078\u006d\u0070\u0069\u0064\u0071":&XmpIDQualSchema ,_gg .NsPDF .URI :&PdfSchema ,"\u0073\u0074\u0045v\u0074":&FieldResourceEventSchema ,"\u0073\u0074\u0056e\u0072":&FieldVersionSchema };
};
...
func (_gge *Model )SyncModel (d *_eg .Document )error {return nil };var FieldVersionSchema =Schema {NamespaceURI :"\u0068\u0074\u0074p\u003a\u002f\u002f\u006e\u0073\u002e\u0061\u0064\u006f\u0062\u0065\u002e\u0063\u006f\u006d\u002f\u0078\u0061\u0070\u002f\u0031\u002e\u0030\u002f\u0073\u0054\u0079\u0070\u0065/\u0056\u0065\u0072\u0073\u0069\u006f\u006e\u0023",Prefix :"\u0073\u0074\u0056e\u0072",Schema :"\u0042a\u0073\u0069\u0063\u0020\u0076\u0061\u006c\u0075\u0065\u0020\u0074y\u0070\u0065\u0020\u0056\u0065\u0072\u0073\u0069\u006f\u006e",Property :[]Property {{Category :PropertyCategoryInternal ,Description :"\u0043\u006fmm\u0065\u006e\u0074s\u0020\u0063\u006f\u006ecer\u006ein\u0067\u0020\u0077\u0068\u0061\u0074\u0020wa\u0073\u0020\u0063\u0068\u0061\u006e\u0067e\u0064",Name :"\u0063\u006f\u006d\u006d\u0065\u006e\u0074\u0073",ValueType :ValueTypeNameText },{Category :PropertyCategoryInternal ,Description :"\u0048\u0069\u0067\u0068\u0020\u006c\u0065\u0076\u0065\u006c\u002c\u0020\u0066\u006f\u0072\u006d\u0061\u006c\u0020\u0064e\u0073\u0063\u0072\u0069\u0070\u0074\u0069\u006f\u006e\u0020\u006f\u0066\u0020\u0077\u0068\u0061\u0074\u0020\u006f\u0070\u0065r\u0061\u0074\u0069\u006f\u006e\u0020\u0074\u0068\u0065\u0020\u0075\u0073\u0065\u0072 \u0070\u0065\u0072f\u006f\u0072\u006d\u0065\u0064\u002e",Name :"\u0065\u0076\u0065n\u0074",ValueType :ValueTypeResourceEvent },{Category :PropertyCategoryInternal ,Description :"\u0054\u0068e\u0020\u0064\u0061\u0074\u0065\u0020\u006f\u006e\u0020\u0077\u0068\u0069\u0063\u0068\u0020\u0074\u0068\u0069\u0073\u0020\u0076\u0065\u0072\u0073\u0069\u006f\u006e\u0020\u0077\u0061\u0073\u0020\u0063\u0068\u0065\u0063\u006b\u0065\u0064\u0020\u0069\u006e\u002e",Name :"\u006d\u006f\u0064\u0069\u0066\u0079\u0044\u0061\u0074\u0065",ValueType :ValueTypeNameDate },{Category :PropertyCategoryInternal ,Description :"\u0054\u0068e\u0020\u0070\u0065\u0072s\u006f\u006e \u0077\u0068\u006f\u0020\u006d\u006f\u0064\u0069f\u0069\u0065\u0064\u0020\u0074\u0068\u0069\u0073\u0020\u0076\u0065\u0072s\u0069\u006f\u006e\u002e",Name :"\u006d\u006f\u0064\u0069\u0066\u0069\u0065\u0072",ValueType :ValueTypeNameProperName },{Category :PropertyCategoryInternal ,Description :"\u0054\u0068\u0065 n\u0065\u0077\u0020\u0076\u0065\u0072\u0073\u0069\u006f\u006e\u0020\u006e\u0075\u006d\u0062\u0065\u0072\u002e",Name :"\u0076e\u0072\u0073\u0069\u006f\u006e",ValueType :ValueTypeNameText }},ValueType :nil };


// Typ gets the array type of properties.
func (_bbc Properties )Typ ()_eg .ArrayType {return _eg .ArrayTypeOrdered };

// ValueTypeName is the name of the value type.
type ValueTypeName string ;

// MakeModel creates or gets a model from document.
func MakeModel (d *_eg .Document )(*Model ,error ){_ea ,_egc :=d .MakeModel (Namespace );if _egc !=nil {return nil ,_egc ;};return _ea .(*Model ),nil ;};

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_bgf *ValueTypes )UnmarshalXMP (d *_eg .Decoder ,node *_eg .Node ,m _eg .Model )error {return _eg .UnmarshalArray (d ,node ,_bgf .Typ (),_bgf );};

// GetSchema for provided namespace.
func GetSchema (namespaceURI string )(*Schema ,bool ){_ffe .RLock ();defer _ffe .RUnlock ();_acc ,_cfc :=_cb [namespaceURI ];return _acc ,_cfc ;};

// Can implements xmp.Model interface.
func (_ddd *Model )Can (nsName string )bool {return Namespace .GetName ()==nsName };

// SyncFromXMP implements xmp.Model interface.
func (_fg *Model )SyncFromXMP (d *_eg .Document )error {return nil };

// Properties is a list of properties.
type Properties []Property ;

// FillModel fills in the document XMP model.
func FillModel (d *_eg .Document ,extModel *Model )error {var _af []*_eg .Namespace ;for _ ,_ad :=range d .Namespaces (){_af =append (_af ,_ad );};_cf .Slice (_af ,func (_eb ,_ca int )bool {return _af [_eb ].Name < _af [_ca ].Name });for _ ,_bf :=range _af {switch _bf {case Namespace ,SchemaNS ,PropertyNS ,ValueTypeNS ,FieldNS ,_da .NsXmp ,_ag .NsDc :continue ;
default:_ge ,_gf :=GetSchema (_bf .URI );if !_gf {continue ;};_bb :=d .FindModel (_bf );_gef :=*_ge ;_gef .Property =Properties {};for _ ,_adb :=range _ge .Property {_bc :=_ega (_bb ,_bf ,_adb );if _bc {_gef .Property =append (_gef .Property ,_adb );};
};if len (_gef .Property )==0{continue ;};var _gb bool ;for _ff ,_ba :=range extModel .Schemas {if _ba .Schema ==_gef .Schema {_gb =true ;extModel .Schemas [_ff ]=_gef ;break ;};};if !_gb {extModel .Schemas =append (extModel .Schemas ,_gef );};};};return nil ;
};
...
// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_ccb *Properties )UnmarshalXMP (d *_eg .Decoder ,node *_eg .Node ,m _eg .Model )error {return _eg .UnmarshalArray (d ,node ,_ccb .Typ (),_ccb );};
...
func (_df *Model )Namespaces ()_eg .NamespaceList {return _eg .NamespaceList {Namespace }};

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_egaa *Schemas )UnmarshalXMP (d *_eg .Decoder ,node *_eg .Node ,m _eg .Model )error {return _eg .UnmarshalArray (d ,node ,_egaa .Typ (),_egaa );};

// PropertyCategory is the property category enumerator.
type PropertyCategory int ;const (ValueTypeNameBoolean ValueTypeName ="\u0042o\u006f\u006c\u0065\u0061\u006e";ValueTypeNameDate ValueTypeName ="\u0044\u0061\u0074\u0065";ValueTypeNameInteger ValueTypeName ="\u0049n\u0074\u0065\u0067\u0065\u0072";ValueTypeNameReal ValueTypeName ="\u0052\u0065\u0061\u006c";
...
func (_aca *Model )SetTag (tag ,value string )error {if _afb :=_eg .SetNativeField (_aca ,tag ,value );_afb !=nil {return _c .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_afb );};return nil ;};
...
func (_cff *Model )CanTag (tag string )bool {_ ,_ac :=_eg .GetNativeField (_cff ,tag );return _ac ==nil ;};
...
// MarshalXMP implements xmp.Marshaler interface.
func (_gbd ValueTypes )MarshalXMP (e *_eg .Encoder ,node *_eg .Node ,m _eg .Model )error {return _eg .MarshalArray (e ,node ,_gbd .Typ (),_gbd );};