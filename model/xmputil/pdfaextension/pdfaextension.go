...
func (_ebg *Model )CanTag (tag string )bool {_ ,_bgcc :=_e .GetNativeField (_ebg ,tag );return _bgcc ==nil ;};

// FieldValueType is a schema that describes a field in a structured type.
type FieldValueType struct{Name string `xmp:"pdfaField:description"`;Description string `xmp:"pdfaField:name"`;ValueType ValueTypeName `xmp:"pdfaField:valueType"`;};func init (){_ebe =map[string ]*Schema {_fb .NsXmpMM .URI :&XmpMediaManagementSchema ,"\u0078\u006d\u0070\u0069\u0064\u0071":&XmpIDQualSchema ,_fbf .NsPDF .URI :&PdfSchema ,"\u0073\u0074\u0045v\u0074":&FieldResourceEventSchema ,"\u0073\u0074\u0056e\u0072":&FieldVersionSchema };
...
func GetSchema (namespaceURI string )(*Schema ,bool ){_ad .RLock ();defer _ad .RUnlock ();_df ,_fga :=_ebe [namespaceURI ];return _df ,_fga ;};
...
func AltOfValueTypeName (vt ValueTypeName )ValueTypeName {return "\u0061\u006c\u0074\u0020"+vt };var (Namespace =_e .NewNamespace ("\u0070\u0064\u0066\u0061\u0045\u0078\u0074\u0065\u006e\u0073\u0069\u006f\u006e","\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067\u002f\u0070\u0064\u0066\u0061/\u006e\u0073\u002f\u0065\u0078t\u0065\u006es\u0069\u006f\u006e\u002f",NewModel );
...
func FillModel (d *_e .Document ,extModel *Model )error {var _b []*_e .Namespace ;for _ ,_ef :=range d .Namespaces (){_b =append (_b ,_ef );};_ae .Slice (_b ,func (_ee ,_eg int )bool {return _b [_ee ].Name < _b [_eg ].Name });for _ ,_be :=range _b {switch _be {case Namespace ,SchemaNS ,PropertyNS ,ValueTypeNS ,FieldNS ,_gc .NsXmp ,_agg .NsDc :continue ;
default:_gec ,_bg :=GetSchema (_be .URI );if !_bg {continue ;};_bga :=d .FindModel (_be );_af :=*_gec ;_af .Property =Properties {};for _ ,_fa :=range _gec .Property {_gd :=_bgc (_bga ,_be ,_fa );if _gd {_af .Property =append (_af .Property ,_fa );};};
if len (_af .Property )==0{continue ;};var _ce bool ;for _aea ,_ed :=range extModel .Schemas {if _ed .Schema ==_af .Schema {_ce =true ;extModel .Schemas [_aea ]=_af ;break ;};};if !_ce {extModel .Schemas =append (extModel .Schemas ,_af );};};};return nil ;
};

// Properties is a list of properties.
type Properties []Property ;var (_ebe =map[string ]*Schema {};_ad _g .RWMutex ;);

// SyncFromXMP implements xmp.Model interface.
func (_bee *Model )SyncFromXMP (d *_e .Document )error {return nil };

// SyncToXMP implements xmp.Model interface.
func (_fff *Model )SyncToXMP (d *_e .Document )error {return nil };

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_fec *Properties )UnmarshalXMP (d *_e .Decoder ,node *_e .Node ,m _e .Model )error {return _e .UnmarshalArray (d ,node ,_fec .Typ (),_fec );};var XmpIDQualSchema =Schema {NamespaceURI :"\u0068t\u0074\u0070:\u002f\u002f\u006e\u0073.\u0061\u0064\u006fb\u0065\u002e\u0063\u006f\u006d\u002f\u0078\u006d\u0070/I\u0064\u0065\u006et\u0069\u0066i\u0065\u0072\u002f\u0071\u0075\u0061l\u002f\u0031.\u0030\u002f",Prefix :"\u0078\u006d\u0070\u0069\u0064\u0071",Schema :"X\u004dP\u0020\u0078\u006d\u0070\u0069\u0064\u0071\u0020q\u0075\u0061\u006c\u0069fi\u0065\u0072",Property :[]Property {{Category :PropertyCategoryInternal ,Name :"\u0053\u0063\u0068\u0065\u006d\u0065",Description :"\u0041\u0020\u0071\u0075\u0061\u006c\u0069\u0066\u0069\u0065\u0072\u0020\u0070\u0072o\u0076\u0069\u0064i\u006e\u0067\u0020\u0074h\u0065\u0020\u006e\u0020\u0061\u006d\u0065\u0020\u006f\u0066\u0020\u0074\u0068\u0065\u0020\u0066\u006f\u0072\u006d\u0061\u006c \u0069\u0064\u0065n\u0074\u0069\u0066\u0069\u0063\u0061\u0074\u0069\u006f\u006e\u0020\u0073\u0063\u0068\u0065\u006d\u0065\u0020\u0075\u0073ed\u0020\u0066\u006fr\u0020\u0061\u006e\u0020\u0069\u0074\u0065\u006d \u0069\u006e\u0020\u0074\u0068\u0065\u0020\u0078\u006d\u0070\u003a\u0049\u0064\u0065\u006e\u0074\u0069\u0066\u0069\u0065\u0072\u0020\u0061\u0072\u0072\u0061\u0079\u002e",ValueType :ValueTypeNameText }},ValueType :nil };


// MarshalText implements encoding.TextMarshaler interface.
func (_da PropertyCategory )MarshalText ()([]byte ,error ){switch _da {case PropertyCategoryInternal :return []byte ("\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;case PropertyCategoryExternal :return []byte ("\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;
case PropertyCategoryUndefined :return []byte (""),nil ;default:return nil ,_a .Errorf ("\u0075\u006ed\u0065\u0066\u0069\u006ee\u0064\u0020p\u0072\u006f\u0070\u0065\u0072\u0074\u0079\u0020c\u0061\u0074\u0065\u0067\u006f\u0072\u0079\u0020\u0076\u0061\u006c\u0075e\u003a\u0020\u0025\u0076",_da );
};};

// UnmarshalText implements encoding.TextUnmarshaler interface.
func (_bf *PropertyCategory )UnmarshalText (in []byte )error {switch string (in ){case "\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c":*_bf =PropertyCategoryInternal ;case "\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c":*_bf =PropertyCategoryExternal ;
default:*_bf =PropertyCategoryUndefined ;};return nil ;};func _bgc (_fd _e .Model ,_bc *_e .Namespace ,_afa Property )bool {_cef :=_ag .ValueOf (_fd ).Elem ();if _cef .Kind ()==_ag .Ptr {_cef =_cef .Elem ();};_bcb :=_cef .Type ();for _fe :=0;_fe < _bcb .NumField ();
_fe ++{_dg :=_bcb .Field (_fe );_bb :=_dg .Tag .Get ("\u0078\u006d\u0070");if _bb ==""{continue ;};if !_f .HasPrefix (_bb ,_bc .Name ){continue ;};_aa :=_f .IndexRune (_bb ,':');if _aa ==-1{continue ;};_ab :=_bb [_aa +1:];if _ab ==_afa .Name {_cf :=_cef .Field (_fe );
return !_cf .IsZero ();};};return false ;};

// IsZero checks if the resources list has no entries.
func (_bgad Schemas )IsZero ()bool {return len (_bgad )==0};
...
// MarshalXMP implements xmp.Marshaler interface.
func (_aead Properties )MarshalXMP (e *_e .Encoder ,node *_e .Node ,m _e .Model )error {return _e .MarshalArray (e ,node ,_aead .Typ (),_aead );};func (_ac Schemas )Typ ()_e .ArrayType {return _e .ArrayTypeUnordered };const (PropertyCategoryUndefined PropertyCategory =iota ;
...
func (_efc *Model )Namespaces ()_e .NamespaceList {return _e .NamespaceList {Namespace }};

// MakeModel creates or gets a model from document.
func MakeModel (d *_e .Document )(*Model ,error ){_d ,_ge :=d .MakeModel (Namespace );if _ge !=nil {return nil ,_ge ;};return _d .(*Model ),nil ;};

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_gcd *ValueTypes )UnmarshalXMP (d *_e .Decoder ,node *_e .Node ,m _e .Model )error {return _e .UnmarshalArray (d ,node ,_gcd .Typ (),_gcd );};