...
func (_fdb *Model )Namespaces ()_da .NamespaceList {return _da .NamespaceList {Namespace }};

// PropertyCategory is the property category enumerator.
type PropertyCategory int ;

// Typ gets the array type of properties.
func (_dgea Properties )Typ ()_da .ArrayType {return _da .ArrayTypeOrdered };
...
func (_cc *PropertyCategory )UnmarshalText (in []byte )error {switch string (in ){case "\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c":*_cc =PropertyCategoryInternal ;case "\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c":*_cc =PropertyCategoryExternal ;
default:*_cc =PropertyCategoryUndefined ;};return nil ;};

// Properties is a list of properties.
type Properties []Property ;func init (){_bc =map[string ]*Schema {_c .NsXmpMM .URI :&XmpMediaManagementSchema ,"\u0078\u006d\u0070\u0069\u0064\u0071":&XmpIDQualSchema ,_de .NsPDF .URI :&PdfSchema ,"\u0073\u0074\u0045v\u0074":&FieldResourceEventSchema ,"\u0073\u0074\u0056e\u0072":&FieldVersionSchema };
};

// MakeModel creates or gets a model from document.
func MakeModel (d *_da .Document )(*Model ,error ){_ac ,_ae :=d .MakeModel (Namespace );if _ae !=nil {return nil ,_ae ;};return _ac .(*Model ),nil ;};const (ValueTypeResourceEvent ValueTypeName ="\u0052\u0065\u0073\u006f\u0075\u0072\u0063\u0065\u0045\u0076\u0065\u006e\u0074";
);
...
func (_gfc PropertyCategory )MarshalText ()([]byte ,error ){switch _gfc {case PropertyCategoryInternal :return []byte ("\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;case PropertyCategoryExternal :return []byte ("\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;
case PropertyCategoryUndefined :return []byte (""),nil ;default:return nil ,_d .Errorf ("\u0075\u006ed\u0065\u0066\u0069\u006ee\u0064\u0020p\u0072\u006f\u0070\u0065\u0072\u0074\u0079\u0020c\u0061\u0074\u0065\u0067\u006f\u0072\u0079\u0020\u0076\u0061\u006c\u0075e\u003a\u0020\u0025\u0076",_gfc );
};};

// SyncToXMP implements xmp.Model interface.
func (_gfg *Model )SyncToXMP (d *_da .Document )error {return nil };

// MarshalXMP implements xmp.Marshaler interface.
func (_cb ValueTypes )MarshalXMP (e *_da .Encoder ,node *_da .Node ,m _da .Model )error {return _da .MarshalArray (e ,node ,_cb .Typ (),_cb );};

// MarshalXMP implements xmp.Marshaler interface.
func (_cce Schemas )MarshalXMP (e *_da .Encoder ,node *_da .Node ,m _da .Model )error {return _da .MarshalArray (e ,node ,_cce .Typ (),_cce );};const (ValueTypeNameBoolean ValueTypeName ="\u0042o\u006f\u006c\u0065\u0061\u006e";ValueTypeNameDate ValueTypeName ="\u0044\u0061\u0074\u0065";
...
func (_ddg *Model )SyncFromXMP (d *_da .Document )error {return nil };

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_afd *ValueTypes )UnmarshalXMP (d *_da .Decoder ,node *_da .Node ,m _da .Model )error {return _da .UnmarshalArray (d ,node ,_afd .Typ (),_afd );};
...
func FillModel (d *_da .Document ,extModel *Model )error {var _acd []*_da .Namespace ;for _ ,_b :=range d .Namespaces (){_acd =append (_acd ,_b );};_gf .Slice (_acd ,func (_gg ,_gga int )bool {return _acd [_gg ].Name < _acd [_gga ].Name });for _ ,_aa :=range _acd {switch _aa {case Namespace ,SchemaNS ,PropertyNS ,ValueTypeNS ,FieldNS ,_gc .NsXmp ,_af .NsDc :continue ;
default:_ea ,_ca :=GetSchema (_aa .URI );if !_ca {continue ;};_df :=d .FindModel (_aa );_ead :=*_ea ;_ead .Property =Properties {};for _ ,_be :=range _ea .Property {_gdg :=_beb (_df ,_aa ,_be );if _gdg {_ead .Property =append (_ead .Property ,_be );};};
if len (_ead .Property )==0{continue ;};var _ba bool ;for _gb ,_dd :=range extModel .Schemas {if _dd .Schema ==_ead .Schema {_ba =true ;extModel .Schemas [_gb ]=_ead ;break ;};};if !_ba {extModel .Schemas =append (extModel .Schemas ,_ead );};};};return nil ;
};

// Can implements xmp.Model interface.
func (_fd *Model )Can (nsName string )bool {return Namespace .GetName ()==nsName };const (PropertyCategoryUndefined PropertyCategory =iota ;PropertyCategoryInternal ;PropertyCategoryExternal ;);var (Namespace =_da .NewNamespace ("\u0070\u0064\u0066\u0061\u0045\u0078\u0074\u0065\u006e\u0073\u0069\u006f\u006e","\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067\u002f\u0070\u0064\u0066\u0061/\u006e\u0073\u002f\u0065\u0078t\u0065\u006es\u0069\u006f\u006e\u002f",NewModel );
...
// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_ce *Properties )UnmarshalXMP (d *_da .Decoder ,node *_da .Node ,m _da .Model )error {return _da .UnmarshalArray (d ,node ,_ce .Typ (),_ce );};

// SetSchema sets the schema into given model.
func (_fg *Model )SetSchema (namespaceURI string ,s Schema ){for _caa :=0;_caa < len (_fg .Schemas );_caa ++{if _fg .Schemas [_caa ].NamespaceURI ==namespaceURI {_fg .Schemas [_caa ]=s ;return ;};};_fg .Schemas =append (_fg .Schemas ,s );};

// IsZero checks if the resources list has no entries.
func (_caad Schemas )IsZero ()bool {return len (_caad )==0};

// SyncModel implements xmp.Model interface.
func (_ge *Model )SyncModel (d *_da .Document )error {return nil };

// SeqOfValueTypeName gets a value type name of a sequence of input value type names.
func SeqOfValueTypeName (vt ValueTypeName )ValueTypeName {return "\u0073\u0065\u0071\u0020"+vt };var (_bc =map[string ]*Schema {};_cd _a .RWMutex ;);

// GetSchema for provided namespace.
func GetSchema (namespaceURI string )(*Schema ,bool ){_cd .RLock ();defer _cd .RUnlock ();_ad ,_add :=_bc [namespaceURI ];return _ad ,_add ;};
...
func RegisterSchema (ns *_da .Namespace ,schema *Schema ){_cd .Lock ();defer _cd .Unlock ();_bc [ns .URI ]=schema ;};

// CanTag implements xmp.Model interface.
func (_bff *Model )CanTag (tag string )bool {_ ,_ddga :=_da .GetNativeField (_bff ,tag );return _ddga ==nil ;};

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_gdc *Schemas )UnmarshalXMP (d *_da .Decoder ,node *_da .Node ,m _da .Model )error {return _da .UnmarshalArray (d ,node ,_gdc .Typ (),_gdc );};

// GetTag implements xmp.Model interface.
func (_daf *Model )GetTag (tag string )(string ,error ){_ed ,_ddc :=_da .GetNativeField (_daf ,tag );if _ddc !=nil {return "",_d .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_ddc );};return _ed ,nil ;};