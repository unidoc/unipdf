...
package pdfaextension ;import (_c "fmt";_a "github.com/trimmer-io/go-xmp/models/dc";_d "github.com/trimmer-io/go-xmp/models/pdf";_fc "github.com/trimmer-io/go-xmp/models/xmp_base";_gf "github.com/trimmer-io/go-xmp/models/xmp_mm";_de "github.com/trimmer-io/go-xmp/xmp";
_ga "reflect";_cg "sort";_ge "strings";_f "sync";);

// Typ gets array type of the field value types.
func (_gdac ValueTypes )Typ ()_de .ArrayType {return _de .ArrayTypeOrdered };func init (){_de .Register (Namespace ,_de .XmpMetadata );_de .Register (SchemaNS );_de .Register (PropertyNS );_de .Register (ValueTypeNS );_de .Register (FieldNS );};

// MarshalXMP implements xmp.Marshaler interface.
func (_ded Properties )MarshalXMP (e *_de .Encoder ,node *_de .Node ,m _de .Model )error {return _de .MarshalArray (e ,node ,_ded .Typ (),_ded );};
...
func (_efd *ValueTypes )UnmarshalXMP (d *_de .Decoder ,node *_de .Node ,m _de .Model )error {return _de .UnmarshalArray (d ,node ,_efd .Typ (),_efd );};
...
func (_fb *PropertyCategory )UnmarshalText (in []byte )error {switch string (in ){case "\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c":*_fb =PropertyCategoryInternal ;case "\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c":*_fb =PropertyCategoryExternal ;
default:*_fb =PropertyCategoryUndefined ;};return nil ;};
...
// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_abb *Properties )UnmarshalXMP (d *_de .Decoder ,node *_de .Node ,m _de .Model )error {return _de .UnmarshalArray (d ,node ,_abb .Typ (),_abb );};

// MarshalText implements encoding.TextMarshaler interface.
func (_dcg PropertyCategory )MarshalText ()([]byte ,error ){switch _dcg {case PropertyCategoryInternal :return []byte ("\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;case PropertyCategoryExternal :return []byte ("\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;
case PropertyCategoryUndefined :return []byte (""),nil ;default:return nil ,_c .Errorf ("\u0075\u006ed\u0065\u0066\u0069\u006ee\u0064\u0020p\u0072\u006f\u0070\u0065\u0072\u0074\u0079\u0020c\u0061\u0074\u0065\u0067\u006f\u0072\u0079\u0020\u0076\u0061\u006c\u0075e\u003a\u0020\u0025\u0076",_dcg );
};};
...
func (_fcc *Model )SetSchema (namespaceURI string ,s Schema ){for _ec :=0;_ec < len (_fcc .Schemas );_ec ++{if _fcc .Schemas [_ec ].NamespaceURI ==namespaceURI {_fcc .Schemas [_ec ]=s ;return ;};};_fcc .Schemas =append (_fcc .Schemas ,s );};

// SyncFromXMP implements xmp.Model interface.
func (_ea *Model )SyncFromXMP (d *_de .Document )error {return nil };const (ValueTypeNameBoolean ValueTypeName ="\u0042o\u006f\u006c\u0065\u0061\u006e";ValueTypeNameDate ValueTypeName ="\u0044\u0061\u0074\u0065";ValueTypeNameInteger ValueTypeName ="\u0049n\u0074\u0065\u0067\u0065\u0072";
...
ValueTypeNameURI ValueTypeName ="\u0055\u0052\u0049";ValueTypeNameVersion ValueTypeName ="\u0056e\u0072\u0073\u0069\u006f\u006e";);var (Namespace =_de .NewNamespace ("\u0070\u0064\u0066\u0061\u0045\u0078\u0074\u0065\u006e\u0073\u0069\u006f\u006e","\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067\u002f\u0070\u0064\u0066\u0061/\u006e\u0073\u002f\u0065\u0078t\u0065\u006es\u0069\u006f\u006e\u002f",NewModel );
...
func GetSchema (namespaceURI string )(*Schema ,bool ){_abc .RLock ();defer _abc .RUnlock ();_cde ,_ad :=_bff [namespaceURI ];return _cde ,_ad ;};

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_ff *Schemas )UnmarshalXMP (d *_de .Decoder ,node *_de .Node ,m _de .Model )error {return _de .UnmarshalArray (d ,node ,_ff .Typ (),_ff );};
...
// MarshalXMP implements xmp.Marshaler interface.
func (_bb Schemas )MarshalXMP (e *_de .Encoder ,node *_de .Node ,m _de .Model )error {return _de .MarshalArray (e ,node ,_bb .Typ (),_bb );};
