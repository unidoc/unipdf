...
package pdfaextension ;import (_d "fmt";_da "github.com/trimmer-io/go-xmp/models/dc";_a "github.com/trimmer-io/go-xmp/models/pdf";_dc "github.com/trimmer-io/go-xmp/models/xmp_base";_f "github.com/trimmer-io/go-xmp/models/xmp_mm";_fc "github.com/trimmer-io/go-xmp/xmp";
_c "reflect";_eb "sort";_ee "strings";_e "sync";);

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_feb *Properties )UnmarshalXMP (d *_fc .Decoder ,node *_fc .Node ,m _fc .Model )error {return _fc .UnmarshalArray (d ,node ,_feb .Typ (),_feb );};func init (){_fc .Register (Namespace ,_fc .XmpMetadata );_fc .Register (SchemaNS );_fc .Register (PropertyNS );
...
func (_bab *Model )CanTag (tag string )bool {_ ,_bf :=_fc .GetNativeField (_bab ,tag );return _bf ==nil ;};
...
func (_beb *Model )SyncFromXMP (d *_fc .Document )error {return nil };
...
func (_cad ValueTypes )Typ ()_fc .ArrayType {return _fc .ArrayTypeOrdered };var (Namespace =_fc .NewNamespace ("\u0070\u0064\u0066\u0061\u0045\u0078\u0074\u0065\u006e\u0073\u0069\u006f\u006e","\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067\u002f\u0070\u0064\u0066\u0061/\u006e\u0073\u002f\u0065\u0078t\u0065\u006es\u0069\u006f\u006e\u002f",NewModel );
...
func (_fd *Model )Can (nsName string )bool {return Namespace .GetName ()==nsName };

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_fbg *ValueTypes )UnmarshalXMP (d *_fc .Decoder ,node *_fc .Node ,m _fc .Model )error {return _fc .UnmarshalArray (d ,node ,_fbg .Typ (),_fbg );};

// Typ gets the array type of properties.
func (_bgf Properties )Typ ()_fc .ArrayType {return _fc .ArrayTypeOrdered };func init (){_bgc =map[string ]*Schema {_f .NsXmpMM .URI :&XmpMediaManagementSchema ,"\u0078\u006d\u0070\u0069\u0064\u0071":&XmpIDQualSchema ,_a .NsPDF .URI :&PdfSchema ,"\u0073\u0074\u0045v\u0074":&FieldResourceEventSchema ,"\u0073\u0074\u0056e\u0072":&FieldVersionSchema };
};

// FillModel fills in the document XMP model.
func FillModel (d *_fc .Document ,extModel *Model )error {var _aa []*_fc .Namespace ;for _ ,_ga :=range d .Namespaces (){_aa =append (_aa ,_ga );};_eb .Slice (_aa ,func (_fb ,_ef int )bool {return _aa [_fb ].Name < _aa [_ef ].Name });for _ ,_ge :=range _aa {switch _ge {case Namespace ,SchemaNS ,PropertyNS ,ValueTypeNS ,FieldNS ,_dc .NsXmp ,_da .NsDc :continue ;
default:_fe ,_fg :=GetSchema (_ge .URI );if !_fg {continue ;};_cgf :=d .FindModel (_ge );_dad :=*_fe ;_dad .Property =Properties {};for _ ,_bc :=range _fe .Property {_de :=_gg (_cgf ,_ge ,_bc );if _de {_dad .Property =append (_dad .Property ,_bc );};};
if len (_dad .Property )==0{continue ;};var _cb bool ;for _ea ,_ceb :=range extModel .Schemas {if _ceb .Schema ==_dad .Schema {_cb =true ;extModel .Schemas [_ea ]=_dad ;break ;};};if !_cb {extModel .Schemas =append (extModel .Schemas ,_dad );};};};return nil ;
};
...
func (_fbb *Model )SetSchema (namespaceURI string ,s Schema ){for _ba :=0;_ba < len (_fbb .Schemas );_ba ++{if _fbb .Schemas [_ba ].NamespaceURI ==namespaceURI {_fbb .Schemas [_ba ]=s ;return ;};};_fbb .Schemas =append (_fbb .Schemas ,s );};

// Properties is a list of properties.
type Properties []Property ;const (PropertyCategoryUndefined PropertyCategory =iota ;PropertyCategoryInternal ;PropertyCategoryExternal ;);

// ValueTypes is the slice of field value types.
type ValueTypes []FieldValueType ;

// SetTag implements xmp.Model interface.
func (_cc *Model )SetTag (tag ,value string )error {if _baba :=_fc .SetNativeField (_cc ,tag ,value );_baba !=nil {return _d .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_baba );};return nil ;};

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_gc *Schemas )UnmarshalXMP (d *_fc .Decoder ,node *_fc .Node ,m _fc .Model )error {return _fc .UnmarshalArray (d ,node ,_gc .Typ (),_gc );};func (_aef Schemas )Typ ()_fc .ArrayType {return _fc .ArrayTypeUnordered };

// PropertyCategory is the property category enumerator.
type PropertyCategory int ;

// GetTag implements xmp.Model interface.
func (_bg *Model )GetTag (tag string )(string ,error ){_fed ,_cd :=_fc .GetNativeField (_bg ,tag );if _cd !=nil {return "",_d .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_cd );};return _fed ,nil ;};var FieldResourceEventSchema =Schema {NamespaceURI :"\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u006es\u002e\u0061\u0064ob\u0065\u002e\u0063\u006f\u006d\u002fx\u0061\u0070\u002f\u0031\u002e\u0030\u002f\u0073\u0054\u0079\u0070\u0065\u002f\u0052\u0065s\u006f\u0075\u0072\u0063\u0065\u0045\u0076\u0065n\u0074\u0023",Prefix :"\u0073\u0074\u0045v\u0074",Schema :"\u0044e\u0066\u0069n\u0069\u0074\u0069\u006fn\u0020\u006f\u0066 \u0062\u0061\u0073\u0069\u0063\u0020\u0076\u0061\u006cue\u0020\u0074\u0079p\u0065\u0020R\u0065\u0073\u006f\u0075\u0072\u0063e\u0045\u0076e\u006e\u0074",Property :[]Property {{Category :PropertyCategoryInternal ,Description :"\u0054he\u0020a\u0063t\u0069\u006f\u006e\u0020\u0074\u0068a\u0074\u0020\u006f\u0063c\u0075\u0072\u0072\u0065\u0064\u002e\u0020\u0044\u0065\u0066\u0069\u006e\u0065d \u0076\u0061\u006c\u0075\u0065\u0073\u0020\u0061\u0072\u0065\u003a\u0020\u0063\u006f\u006e\u0076\u0065\u0072\u0074\u0065d\u002c \u0063\u006f\u0070\u0069\u0065\u0064\u002c\u0020\u0063\u0072\u0065\u0061\u0074e\u0064\u002c \u0063\u0072\u006fp\u0070\u0065\u0064\u002c\u0020\u0065\u0064\u0069\u0074ed\u002c\u0020\u0066i\u006c\u002d\u0074\u0065r\u0065\u0064\u002c\u0020\u0066\u006fr\u006d\u0061t\u0074\u0065\u0064\u002c\u0020\u0076\u0065\u0072s\u0069\u006f\u006e\u005f\u0075\u0070\u0064\u0061\u0074\u0065\u0064\u002c\u0020\u0070\u0072\u0069\u006e\u0074\u0065\u0064\u002c\u0020\u0070ubli\u0073\u0068\u0065\u0064\u002c\u0020\u006d\u0061\u006e\u0061\u0067\u0065\u0064\u002c\u0020\u0070\u0072\u006f\u0064\u0075\u0063\u0065\u0064\u002c\u0020\u0072\u0065\u0073i\u007ae\u0064.\u004e\u0065\u0077\u0020\u0076\u0061\u006c\u0075\u0065\u0073\u0020\u0073\u0068\u006f\u0075\u006c\u0064\u0020\u0062\u0065 \u0076\u0065r\u0062\u0073 \u0069n\u0020\u0074\u0068\u0065\u0020\u0070a\u0073\u0074\u0020\u0074\u0065\u006e\u0073\u0065\u002e",Name :"\u0061\u0063\u0074\u0069\u006f\u006e",ValueType :"O\u0070\u0065\u006e\u0020\u0043\u0068\u006f\u0069\u0063\u0065"},{Category :PropertyCategoryInternal ,Description :"T\u0068\u0065\u0020\u0069\u006e\u0073\u0074\u0061\u006e\u0063\u0065\u0020\u0049\u0044\u0020\u006f\u0066\u0020t\u0068\u0065\u0020\u006d\u006f\u0064\u0069\u0066\u0069\u0065d \u0072\u0065\u0073o\u0075r\u0063\u0065",Name :"\u0069\u006e\u0073\u0074\u0061\u006e\u0063\u0065\u0049\u0044",ValueType :ValueTypeNameURI },{Category :PropertyCategoryInternal ,Description :"\u0041\u0064di\u0074\u0069\u006fn\u0061\u006c\u0020\u0064esc\u0072ip\u0074\u0069\u006f\u006e\u0020\u006f\u0066 t\u0068\u0065\u0020\u0061\u0063\u0074\u0069o\u006e",Name :"\u0070\u0061\u0072\u0061\u006d\u0065\u0074\u0065\u0072\u0073",ValueType :ValueTypeNameText },{Category :PropertyCategoryInternal ,Description :"\u0054h\u0065\u0020s\u006f\u0066\u0074\u0077a\u0072\u0065\u0020a\u0067\u0065\u006e\u0074\u0020\u0074\u0068\u0061\u0074 p\u0065\u0072\u0066o\u0072\u006de\u0064\u0020\u0074\u0068\u0065\u0020a\u0063\u0074i\u006f\u006e",Name :"\u0073\u006f\u0066\u0074\u0077\u0061\u0072\u0065\u0041\u0067\u0065\u006e\u0074",ValueType :ValueTypeNameAgentName },{Category :PropertyCategoryInternal ,Description :"\u004f\u0070t\u0069\u006f\u006e\u0061\u006c\u0020\u0074\u0069\u006d\u0065\u0073\u0074\u0061\u006d\u0070\u0020\u006f\u0066\u0020\u0077\u0068\u0065\u006e\u0020\u0074\u0068\u0065\u0020\u0061\u0063\u0074\u0069\u006f\u006e\u0020\u006f\u0063\u0063\u0075\u0072\u0072\u0065\u0064",Name :"\u0077\u0068\u0065\u006e",ValueType :ValueTypeNameDate }},ValueType :nil };


// MarshalText implements encoding.TextMarshaler interface.
func (_aad PropertyCategory )MarshalText ()([]byte ,error ){switch _aad {case PropertyCategoryInternal :return []byte ("\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;case PropertyCategoryExternal :return []byte ("\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;
case PropertyCategoryUndefined :return []byte (""),nil ;default:return nil ,_d .Errorf ("\u0075\u006ed\u0065\u0066\u0069\u006ee\u0064\u0020p\u0072\u006f\u0070\u0065\u0072\u0074\u0079\u0020c\u0061\u0074\u0065\u0067\u006f\u0072\u0079\u0020\u0076\u0061\u006c\u0075e\u003a\u0020\u0025\u0076",_aad );
};};

// NewModel creates a new pdfAExtension model.
func NewModel (name string )_fc .Model {return &Model {}};

// MarshalXMP implements xmp.Marshaler interface.
func (_cdc ValueTypes )MarshalXMP (e *_fc .Encoder ,node *_fc .Node ,m _fc .Model )error {return _fc .MarshalArray (e ,node ,_cdc .Typ (),_cdc );};
...
// MarshalXMP implements xmp.Marshaler interface.
func (_ca Properties )MarshalXMP (e *_fc .Encoder ,node *_fc .Node ,m _fc .Model )error {return _fc .MarshalArray (e ,node ,_ca .Typ (),_ca );};