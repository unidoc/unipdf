...
package pdfaextension ;import (_d "fmt";_e "github.com/trimmer-io/go-xmp/models/dc";_c "github.com/trimmer-io/go-xmp/models/pdf";_da "github.com/trimmer-io/go-xmp/models/xmp_base";_ae "github.com/trimmer-io/go-xmp/models/xmp_mm";_ga "github.com/trimmer-io/go-xmp/xmp";
_bf "reflect";_a "sort";_gd "strings";_b "sync";);

// RegisterSchema registers schema extension definition.
func RegisterSchema (ns *_ga .Namespace ,schema *Schema ){_ef .Lock ();defer _ef .Unlock ();_ab [ns .URI ]=schema ;};func init (){_ga .Register (Namespace ,_ga .XmpMetadata );_ga .Register (SchemaNS );_ga .Register (PropertyNS );_ga .Register (ValueTypeNS );
_ga .Register (FieldNS );};const (ValueTypeNameBoolean ValueTypeName ="\u0042o\u006f\u006c\u0065\u0061\u006e";ValueTypeNameDate ValueTypeName ="\u0044\u0061\u0074\u0065";ValueTypeNameInteger ValueTypeName ="\u0049n\u0074\u0065\u0067\u0065\u0072";ValueTypeNameReal ValueTypeName ="\u0052\u0065\u0061\u006c";
...
func (_gb Properties )MarshalXMP (e *_ga .Encoder ,node *_ga .Node ,m _ga .Model )error {return _ga .MarshalArray (e ,node ,_gb .Typ (),_gb );};

// SetSchema sets the schema into given model.
func (_fa *Model )SetSchema (namespaceURI string ,s Schema ){for _de :=0;_de < len (_fa .Schemas );_de ++{if _fa .Schemas [_de ].NamespaceURI ==namespaceURI {_fa .Schemas [_de ]=s ;return ;};};_fa .Schemas =append (_fa .Schemas ,s );};
...
func (_bfb *Model )GetTag (tag string )(string ,error ){_aea ,_acg :=_ga .GetNativeField (_bfb ,tag );if _acg !=nil {return "",_d .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_acg );};return _aea ,nil ;};

// Can implements xmp.Model interface.
func (_fg *Model )Can (nsName string )bool {return Namespace .GetName ()==nsName };const (PropertyCategoryUndefined PropertyCategory =iota ;PropertyCategoryInternal ;PropertyCategoryExternal ;);

// Namespaces implements xmp.Model interface.
func (_ag *Model )Namespaces ()_ga .NamespaceList {return _ga .NamespaceList {Namespace }};func (_ba Schemas )Typ ()_ga .ArrayType {return _ga .ArrayTypeUnordered };
...
func (_efd *Schemas )UnmarshalXMP (d *_ga .Decoder ,node *_ga .Node ,m _ga .Model )error {return _ga .UnmarshalArray (d ,node ,_efd .Typ (),_efd );};const (ValueTypeResourceEvent ValueTypeName ="\u0052\u0065\u0073\u006f\u0075\u0072\u0063\u0065\u0045\u0076\u0065\u006e\u0074";
);var (Namespace =_ga .NewNamespace ("\u0070\u0064\u0066\u0061\u0045\u0078\u0074\u0065\u006e\u0073\u0069\u006f\u006e","\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067\u002f\u0070\u0064\u0066\u0061/\u006e\u0073\u002f\u0065\u0078t\u0065\u006es\u0069\u006f\u006e\u002f",NewModel );
...
);func init (){_ab =map[string ]*Schema {_ae .NsXmpMM .URI :&XmpMediaManagementSchema ,"\u0078\u006d\u0070\u0069\u0064\u0071":&XmpIDQualSchema ,_c .NsPDF .URI :&PdfSchema ,"\u0073\u0074\u0045v\u0074":&FieldResourceEventSchema ,"\u0073\u0074\u0056e\u0072":&FieldVersionSchema };
...
// MarshalXMP implements xmp.Marshaler interface.
func (_fad Schemas )MarshalXMP (e *_ga .Encoder ,node *_ga .Node ,m _ga .Model )error {return _ga .MarshalArray (e ,node ,_fad .Typ (),_fad );};
...
// MarshalXMP implements xmp.Marshaler interface.
func (_fdg ValueTypes )MarshalXMP (e *_ga .Encoder ,node *_ga .Node ,m _ga .Model )error {return _ga .MarshalArray (e ,node ,_fdg .Typ (),_fdg );};
...
func (_bb *Model )CanTag (tag string )bool {_ ,_bbd :=_ga .GetNativeField (_bb ,tag );return _bbd ==nil ;};
...
case PropertyCategoryUndefined :return []byte (""),nil ;default:return nil ,_d .Errorf ("\u0075\u006ed\u0065\u0066\u0069\u006ee\u0064\u0020p\u0072\u006f\u0070\u0065\u0072\u0074\u0079\u0020c\u0061\u0074\u0065\u0067\u006f\u0072\u0079\u0020\u0076\u0061\u006c\u0075e\u003a\u0020\u0025\u0076",_ec );
};};func _dad (_ac _ga .Model ,_ff *_ga .Namespace ,_gag Property )bool {_bfa :=_bf .ValueOf (_ac ).Elem ();if _bfa .Kind ()==_bf .Ptr {_bfa =_bfa .Elem ();};_cdg :=_bfa .Type ();for _eaba :=0;_eaba < _cdg .NumField ();_eaba ++{_eb :=_cdg .Field (_eaba );
_dbd :=_eb .Tag .Get ("\u0078\u006d\u0070");if _dbd ==""{continue ;};if !_gd .HasPrefix (_dbd ,_ff .Name ){continue ;};_bg :=_gd .IndexRune (_dbd ,':');if _bg ==-1{continue ;};_bd :=_dbd [_bg +1:];if _bd ==_gag .Name {_eaf :=_bfa .Field (_eaba );return !_eaf .IsZero ();
};};return false ;};

// MakeModel creates or gets a model from document.
func MakeModel (d *_ga .Document )(*Model ,error ){_dc ,_f :=d .MakeModel (Namespace );if _f !=nil {return nil ,_f ;};return _dc .(*Model ),nil ;};

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_dg *ValueTypes )UnmarshalXMP (d *_ga .Decoder ,node *_ga .Node ,m _ga .Model )error {return _ga .UnmarshalArray (d ,node ,_dg .Typ (),_dg );};

// FillModel fills in the document XMP model.
func FillModel (d *_ga .Document ,extModel *Model )error {var _dca []*_ga .Namespace ;for _ ,_cb :=range d .Namespaces (){_dca =append (_dca ,_cb );};_a .Slice (_dca ,func (_gab ,_ea int )bool {return _dca [_gab ].Name < _dca [_ea ].Name });for _ ,_aa :=range _dca {switch _aa {case Namespace ,SchemaNS ,PropertyNS ,ValueTypeNS ,FieldNS ,_da .NsXmp ,_e .NsDc :continue ;
default:_ca ,_ee :=GetSchema (_aa .URI );if !_ee {continue ;};_db :=d .FindModel (_aa );_bfe :=*_ca ;_bfe .Property =Properties {};for _ ,_eab :=range _ca .Property {_be :=_dad (_db ,_aa ,_eab );if _be {_bfe .Property =append (_bfe .Property ,_eab );};
};if len (_bfe .Property )==0{continue ;};var _aef bool ;for _cdf ,_ead :=range extModel .Schemas {if _ead .Schema ==_bfe .Schema {_aef =true ;extModel .Schemas [_cdf ]=_bfe ;break ;};};if !_aef {extModel .Schemas =append (extModel .Schemas ,_bfe );};};
};return nil ;};var FieldResourceEventSchema =Schema {NamespaceURI :"\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u006es\u002e\u0061\u0064ob\u0065\u002e\u0063\u006f\u006d\u002fx\u0061\u0070\u002f\u0031\u002e\u0030\u002f\u0073\u0054\u0079\u0070\u0065\u002f\u0052\u0065s\u006f\u0075\u0072\u0063\u0065\u0045\u0076\u0065n\u0074\u0023",Prefix :"\u0073\u0074\u0045v\u0074",Schema :"\u0044e\u0066\u0069n\u0069\u0074\u0069\u006fn\u0020\u006f\u0066 \u0062\u0061\u0073\u0069\u0063\u0020\u0076\u0061\u006cue\u0020\u0074\u0079p\u0065\u0020R\u0065\u0073\u006f\u0075\u0072\u0063e\u0045\u0076e\u006e\u0074",Property :[]Property {{Category :PropertyCategoryInternal ,Description :"\u0054he\u0020a\u0063t\u0069\u006f\u006e\u0020\u0074\u0068a\u0074\u0020\u006f\u0063c\u0075\u0072\u0072\u0065\u0064\u002e\u0020\u0044\u0065\u0066\u0069\u006e\u0065d \u0076\u0061\u006c\u0075\u0065\u0073\u0020\u0061\u0072\u0065\u003a\u0020\u0063\u006f\u006e\u0076\u0065\u0072\u0074\u0065d\u002c \u0063\u006f\u0070\u0069\u0065\u0064\u002c\u0020\u0063\u0072\u0065\u0061\u0074e\u0064\u002c \u0063\u0072\u006fp\u0070\u0065\u0064\u002c\u0020\u0065\u0064\u0069\u0074ed\u002c\u0020\u0066i\u006c\u002d\u0074\u0065r\u0065\u0064\u002c\u0020\u0066\u006fr\u006d\u0061t\u0074\u0065\u0064\u002c\u0020\u0076\u0065\u0072s\u0069\u006f\u006e\u005f\u0075\u0070\u0064\u0061\u0074\u0065\u0064\u002c\u0020\u0070\u0072\u0069\u006e\u0074\u0065\u0064\u002c\u0020\u0070ubli\u0073\u0068\u0065\u0064\u002c\u0020\u006d\u0061\u006e\u0061\u0067\u0065\u0064\u002c\u0020\u0070\u0072\u006f\u0064\u0075\u0063\u0065\u0064\u002c\u0020\u0072\u0065\u0073i\u007ae\u0064.\u004e\u0065\u0077\u0020\u0076\u0061\u006c\u0075\u0065\u0073\u0020\u0073\u0068\u006f\u0075\u006c\u0064\u0020\u0062\u0065 \u0076\u0065r\u0062\u0073 \u0069n\u0020\u0074\u0068\u0065\u0020\u0070a\u0073\u0074\u0020\u0074\u0065\u006e\u0073\u0065\u002e",Name :"\u0061\u0063\u0074\u0069\u006f\u006e",ValueType :"O\u0070\u0065\u006e\u0020\u0043\u0068\u006f\u0069\u0063\u0065"},{Category :PropertyCategoryInternal ,Description :"T\u0068\u0065\u0020\u0069\u006e\u0073\u0074\u0061\u006e\u0063\u0065\u0020\u0049\u0044\u0020\u006f\u0066\u0020t\u0068\u0065\u0020\u006d\u006f\u0064\u0069\u0066\u0069\u0065d \u0072\u0065\u0073o\u0075r\u0063\u0065",Name :"\u0069\u006e\u0073\u0074\u0061\u006e\u0063\u0065\u0049\u0044",ValueType :ValueTypeNameURI },{Category :PropertyCategoryInternal ,Description :"\u0041\u0064di\u0074\u0069\u006fn\u0061\u006c\u0020\u0064esc\u0072ip\u0074\u0069\u006f\u006e\u0020\u006f\u0066 t\u0068\u0065\u0020\u0061\u0063\u0074\u0069o\u006e",Name :"\u0070\u0061\u0072\u0061\u006d\u0065\u0074\u0065\u0072\u0073",ValueType :ValueTypeNameText },{Category :PropertyCategoryInternal ,Description :"\u0054h\u0065\u0020s\u006f\u0066\u0074\u0077a\u0072\u0065\u0020a\u0067\u0065\u006e\u0074\u0020\u0074\u0068\u0061\u0074 p\u0065\u0072\u0066o\u0072\u006de\u0064\u0020\u0074\u0068\u0065\u0020a\u0063\u0074i\u006f\u006e",Name :"\u0073\u006f\u0066\u0074\u0077\u0061\u0072\u0065\u0041\u0067\u0065\u006e\u0074",ValueType :ValueTypeNameAgentName },{Category :PropertyCategoryInternal ,Description :"\u004f\u0070t\u0069\u006f\u006e\u0061\u006c\u0020\u0074\u0069\u006d\u0065\u0073\u0074\u0061\u006d\u0070\u0020\u006f\u0066\u0020\u0077\u0068\u0065\u006e\u0020\u0074\u0068\u0065\u0020\u0061\u0063\u0074\u0069\u006f\u006e\u0020\u006f\u0063\u0063\u0075\u0072\u0072\u0065\u0064",Name :"\u0077\u0068\u0065\u006e",ValueType :ValueTypeNameDate }},ValueType :nil };
...
func (_eadc *Model )SetTag (tag ,value string )error {if _gabd :=_ga .SetNativeField (_eadc ,tag ,value );_gabd !=nil {return _d .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_gabd );};return nil ;};
