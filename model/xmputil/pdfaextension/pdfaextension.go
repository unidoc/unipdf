...
package pdfaextension ;import (_b "fmt";_bb "github.com/trimmer-io/go-xmp/models/dc";_gcc "github.com/trimmer-io/go-xmp/models/pdf";_aa "github.com/trimmer-io/go-xmp/models/xmp_base";_a "github.com/trimmer-io/go-xmp/models/xmp_mm";_f "github.com/trimmer-io/go-xmp/xmp";
_d "reflect";_bf "sort";_e "strings";_gc "sync";);

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_aea *Schemas )UnmarshalXMP (d *_f .Decoder ,node *_f .Node ,m _f .Model )error {return _f .UnmarshalArray (d ,node ,_aea .Typ (),_aea );};func init (){_f .Register (Namespace ,_f .XmpMetadata );_f .Register (SchemaNS );_f .Register (PropertyNS );
_f .Register (ValueTypeNS );_f .Register (FieldNS );};

// IsZero checks if the resources list has no entries.
func (_cg Schemas )IsZero ()bool {return len (_cg )==0};
...
type FieldValueType struct{Name string `xmp:"pdfaField:description"`;Description string `xmp:"pdfaField:name"`;ValueType ValueTypeName `xmp:"pdfaField:valueType"`;};const (ValueTypeResourceEvent ValueTypeName ="\u0052\u0065\u0073\u006f\u0075\u0072\u0063\u0065\u0045\u0076\u0065\u006e\u0074";
...
// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_ebb *Properties )UnmarshalXMP (d *_f .Decoder ,node *_f .Node ,m _f .Model )error {return _f .UnmarshalArray (d ,node ,_ebb .Typ (),_ebb );};
...
func (_agdb ValueTypes )MarshalXMP (e *_f .Encoder ,node *_f .Node ,m _f .Model )error {return _f .MarshalArray (e ,node ,_agdb .Typ (),_agdb );};
...
func (_cbg *Model )SyncToXMP (d *_f .Document )error {return nil };var (Namespace =_f .NewNamespace ("\u0070\u0064\u0066\u0061\u0045\u0078\u0074\u0065\u006e\u0073\u0069\u006f\u006e","\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067\u002f\u0070\u0064\u0066\u0061/\u006e\u0073\u002f\u0065\u0078t\u0065\u006es\u0069\u006f\u006e\u002f",NewModel );
SchemaNS =_f .NewNamespace ("\u0070\u0064\u0066\u0061\u0053\u0063\u0068\u0065\u006d\u0061","h\u0074\u0074\u0070\u003a\u002f\u002fw\u0077\u0077\u002e\u0061\u0069\u0069m\u002e\u006f\u0072\u0067\u002f\u0070\u0064f\u0061\u002f\u006e\u0073\u002f\u0073\u0063\u0068\u0065\u006da\u0023",nil );
PropertyNS =_f .NewNamespace ("\u0070\u0064\u0066a\u0050\u0072\u006f\u0070\u0065\u0072\u0074\u0079","\u0068\u0074t\u0070\u003a\u002f\u002fw\u0077\u0077.\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067/\u0070\u0064\u0066\u0061\u002f\u006e\u0073\u002f\u0070\u0072\u006f\u0070e\u0072\u0074\u0079\u0023",nil );
ValueTypeNS =_f .NewNamespace ("\u0070\u0064\u0066\u0061\u0054\u0079\u0070\u0065","\u0068\u0074\u0074\u0070\u003a\u002f/\u0077\u0077\u0077\u002e\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067\u002fp\u0064\u0066\u0061\u002f\u006e\u0073\u002ft\u0079\u0070\u0065\u0023",nil );
FieldNS =_f .NewNamespace ("\u0070d\u0066\u0061\u0046\u0069\u0065\u006cd","\u0068\u0074\u0074p:\u002f\u002f\u0077\u0077\u0077\u002e\u0061\u0069\u0069m\u002eo\u0072g\u002fp\u0064\u0066\u0061\u002f\u006e\u0073\u002f\u0066\u0069\u0065\u006c\u0064\u0023",nil );
);
...
func FillModel (d *_f .Document ,extModel *Model )error {var _af []*_f .Namespace ;for _ ,_be :=range d .Namespaces (){_af =append (_af ,_be );};_bf .Slice (_af ,func (_bg ,_age int )bool {return _af [_bg ].Name < _af [_age ].Name });for _ ,_gg :=range _af {switch _gg {case Namespace ,SchemaNS ,PropertyNS ,ValueTypeNS ,FieldNS ,_aa .NsXmp ,_bb .NsDc :continue ;
default:_c ,_dg :=GetSchema (_gg .URI );if !_dg {continue ;};_da :=d .FindModel (_gg );_fc :=*_c ;_fc .Property =Properties {};for _ ,_cde :=range _c .Property {_ga :=_agd (_da ,_gg ,_cde );if _ga {_fc .Property =append (_fc .Property ,_cde );};};if len (_fc .Property )==0{continue ;
};var _cf bool ;for _fgb ,_ec :=range extModel .Schemas {if _ec .Schema ==_fc .Schema {_cf =true ;extModel .Schemas [_fgb ]=_fc ;break ;};};if !_cf {extModel .Schemas =append (extModel .Schemas ,_fc );};};};return nil ;};func init (){_gcd =map[string ]*Schema {_a .NsXmpMM .URI :&XmpMediaManagementSchema ,"\u0078\u006d\u0070\u0069\u0064\u0071":&XmpIDQualSchema ,_gcc .NsPDF .URI :&PdfSchema ,"\u0073\u0074\u0045v\u0074":&FieldResourceEventSchema ,"\u0073\u0074\u0056e\u0072":&FieldVersionSchema };
};const (PropertyCategoryUndefined PropertyCategory =iota ;PropertyCategoryInternal ;PropertyCategoryExternal ;);func _agd (_bd _f .Model ,_cb *_f .Namespace ,_fcg Property )bool {_dac :=_d .ValueOf (_bd ).Elem ();if _dac .Kind ()==_d .Ptr {_dac =_dac .Elem ();
};_de :=_dac .Type ();for _ca :=0;_ca < _de .NumField ();_ca ++{_fa :=_de .Field (_ca );_ab :=_fa .Tag .Get ("\u0078\u006d\u0070");if _ab ==""{continue ;};if !_e .HasPrefix (_ab ,_cb .Name ){continue ;};_afc :=_e .IndexRune (_ab ,':');if _afc ==-1{continue ;
};_eb :=_ab [_afc +1:];if _eb ==_fcg .Name {_agda :=_dac .Field (_ca );return !_agda .IsZero ();};};return false ;};

// Typ gets the array type of properties.
func (_cc Properties )Typ ()_f .ArrayType {return _f .ArrayTypeOrdered };
...
func (_dc *Model )SyncFromXMP (d *_f .Document )error {return nil };

// MarshalXMP implements xmp.Marshaler interface.
func (_bgc Schemas )MarshalXMP (e *_f .Encoder ,node *_f .Node ,m _f .Model )error {return _f .MarshalArray (e ,node ,_bgc .Typ (),_bgc );};

// SyncModel implements xmp.Model interface.
func (_ff *Model )SyncModel (d *_f .Document )error {return nil };var (_gcd =map[string ]*Schema {};_bae _gc .RWMutex ;);
...
func (_ed *Model )CanTag (tag string )bool {_ ,_bag :=_f .GetNativeField (_ed ,tag );return _bag ==nil };

// SetTag implements xmp.Model interface.
func (_adg *Model )SetTag (tag ,value string )error {if _gaf :=_f .SetNativeField (_adg ,tag ,value );_gaf !=nil {return _b .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_gaf );};return nil ;};
...
// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_bfe *ValueTypes )UnmarshalXMP (d *_f .Decoder ,node *_f .Node ,m _f .Model )error {return _f .UnmarshalArray (d ,node ,_bfe .Typ (),_bfe );};

// Typ gets array type of the field value types.
func (_ecd ValueTypes )Typ ()_f .ArrayType {return _f .ArrayTypeOrdered };

// SetSchema sets the schema into given model.
func (_ba *Model )SetSchema (namespaceURI string ,s Schema ){for _dad :=0;_dad < len (_ba .Schemas );_dad ++{if _ba .Schemas [_dad ].NamespaceURI ==namespaceURI {_ba .Schemas [_dad ]=s ;return ;};};_ba .Schemas =append (_ba .Schemas ,s );};

// MakeModel creates or gets a model from document.
func MakeModel (d *_f .Document )(*Model ,error ){_db ,_fg :=d .MakeModel (Namespace );if _fg !=nil {return nil ,_fg ;};return _db .(*Model ),nil ;};

// UnmarshalText implements encoding.TextUnmarshaler interface.
func (_daf *PropertyCategory )UnmarshalText (in []byte )error {switch string (in ){case "\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c":*_daf =PropertyCategoryInternal ;case "\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c":*_daf =PropertyCategoryExternal ;
default:*_daf =PropertyCategoryUndefined ;};return nil ;};
...
func GetSchema (namespaceURI string )(*Schema ,bool ){_bae .RLock ();defer _bae .RUnlock ();_dae ,_ada :=_gcd [namespaceURI ];return _dae ,_ada ;};
...
type Model struct{Schemas Schemas `xmp:"pdfaExtension:schemas"`;};func (_edg Schemas )Typ ()_f .ArrayType {return _f .ArrayTypeUnordered };