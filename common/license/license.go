...
func SetMeteredKey (apiKey string )error {return _e .SetMeteredKey (apiKey )};func SetMeteredKeyUsageLogVerboseMode (val bool ){_e .SetMeteredKeyUsageLogVerboseMode (val )};
